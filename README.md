...
SQL  databases are a type of relational database. They can be managed through a database management system, like sqlite.

- [ ] Why do tables need a `primary key`?

Tables need a primary key of unique values so that each record is not duplicated, and so that tables can be joined with foreign keys. This way records can be looked up and tables can be joined succesfully. 
...
A junction table to hold the relationship between the many-to-many.
